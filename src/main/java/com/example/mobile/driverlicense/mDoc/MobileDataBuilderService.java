...
public class MobileDataBuilderService {
     ...
     * @return The builder.
     */
    public MobileDataElement putEntryDataItem(@NonNull MobileDataElement mData, @NonNull String namespace, @NonNull String name,
            @NonNull Collection<AccessControlProfileId> accessControlProfileIds,
            @NonNull DataItem value) {
    ...
    public MobileDataElement createMobileDataElement(@NonNull DriverDetails driverDetails) {
